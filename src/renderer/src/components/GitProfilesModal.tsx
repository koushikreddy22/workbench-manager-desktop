            ...
            <div className="w-full max-w-xl bg-slate-900 border border-slate-700/60 rounded-2xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden">
                ...
                <div className="p-6 border-b border-slate-800 flex items-center justify-between bg-slate-900/50">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-white tracking-tight">Git <span className="text-orange-400">Profiles</span></h2>
                            <p className="text-slate-400 text-sm font-medium">Manage your multiple Git identities</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-white flex items-center gap-2">
                                        {profile.name}
                                        <span className="text-[10px] px-1.5 py-0.5 rounded bg-slate-700 text-slate-400 uppercase tracking-widest">{profile.description}</span>
                                    </h4>
                    ...
                    {isAdding && (
                        <div className="p-6 bg-slate-800/40 border-2 border-orange-500/30 rounded-2xl space-y-4 animate-in zoom-in-95 duration-200">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-slate-400 uppercase px-1">Brief Description</label>
                                <input
                                    type="text"
